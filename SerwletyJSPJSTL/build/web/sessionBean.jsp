...
<html>
    ...
    <body>
        <jsp:useBean id="myBean" class="ai.beans.SessionTrackerBean"
                     scope="session"/>
        <h2>JSP Session Bean</h2> Dane odczytane z komponentu Java Bean:
        <ul>
            <li>adres IP: <jsp:getProperty name="myBean"
                             property="ip"/>
